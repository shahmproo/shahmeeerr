    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'> Shahmeer Ahmed</p>
        </Link>
        <ul className="list-none hidden sm:flex flex-row gap-10"> {/* Hidden on small screens, flex on medium and larger */}
          {navLinks.map((link) => (
            <li 
            key={link.id}
        ...
        <div className="flex flex-1 justify-end items-center"> {/* Updated to show on all screens */}
